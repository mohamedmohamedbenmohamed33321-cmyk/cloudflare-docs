...
### Are built-in autoscaling and latency-aware routing available?

Not today. Cloudflare plans to add built-in autoscaling and latency-aware routing in a future
release, but there is no announced timeline.
...
See [image management documentation](/containers/platform-details/image-management/#use-pre-built-container-images) for details.
...
Containers do not currently provide persistent disk.
